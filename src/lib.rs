...
//! Lattice-owned facts such as sparsity, shared scales, determinant schedules,
//! and transform kinds are non-certifying scheduling metadata until an exact
//! `Real` or predicate route consumes them.
//!
//! # Examples
//!
//! ```
